    ...
    <div className="pagina">
      ...
      <div className="formulario-box">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="campo">
            <label>
              <input type="radio" name="rol" value="alumno" checked={formData.rol === "alumno"} onChange={handleChange} />
              Alumno
            </label>
            <label style={{ marginLeft: "10px" }}>
              <input type="radio" name="rol" value="profesor" checked={formData.rol === "profesor"} onChange={handleChange} />
              Profesor
            </label>
          </div>
