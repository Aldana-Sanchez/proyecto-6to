...
export default function FormularioInscripcion() {
    ...
    try {
      ...
      await setDoc(
        ref,
        {
          ...
          alumnoApellido: user.apellido,
          alumnoCorreo: user.correo || user.email,
          materias,
  ...
  const mostrarMateria = (nombre) => {
    switch (nombre) {
      ...
      case "Física 1": return <MateriaFisica1 />;
  ...
  return (
    <Container maxWidth="md" sx={{ py: 6 }}>
      <Paper sx={{ p: 4 }}>
        ...
        {alerta && (
          <Alert severity={alerta.includes("") ? "success" : "error"} sx={{ mb: 3 }}>
            {alerta}
          </Alert>
        )}
